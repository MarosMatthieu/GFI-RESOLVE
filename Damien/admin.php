      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            ...
            <button class="navbar-toggle align_burger" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>

            <a href="index.php"><img class="img_logo" src="assets/images/logo.png"></a>
          </div>
...
<body>
	...
	<div class="change-pwd">
		...
		<form action="/action_page.php" method="post">
			...
			<br> <input id="send" type="submit" value="Submit">
		</form>
	</div>
	<br>
	<br>
